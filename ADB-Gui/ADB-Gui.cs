...
namespace ADB_Gui
{
    public partial class ADBGUI : Form
    {
        ...
        public ADBGUI()
        {
            ...
            Settings.Location = new Point(190, 5);
        ...
        {
            new ADB_GUI.Item().Show();
            ds.DroppedDown = !ds.DroppedDown;
        }
        ...
        private void settingsb_Click(object sender, EventArgs e) => Settings.Visible = !Settings.Visible;
        private void settingscb_Click(object sender, EventArgs e) => Settings.Visible = false;

        private void ac_Click(object sender, EventArgs e)
        {
            ADB_GUI.Item[] listshit = new ADB_GUI.Item[0];
            listshit[0] = new ADB_GUI.Item();
            listshit[0].Tittle = "yes";
            listshit[0].Command = "shell dumpsys battery";
            flowLayoutPanel1.Controls.Add(listshit[1]);
        }
